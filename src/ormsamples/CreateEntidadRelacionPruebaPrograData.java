...
public class CreateEntidadRelacionPruebaPrograData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : curso_profesor, estudiante_curso, nombreCurso
