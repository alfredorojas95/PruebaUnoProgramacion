...
import org.orm.PersistentException;
	...
	public class Curso {
		...
		public static String  crearCurso(Curso nuevoCurso, String rutJefeAdm) {
			...
			try {
				String estadoJefeAdm = "persona.rut='" + rutJefeAdm + "'";
				orm.Jefeadministracion lormJefeadministracion = orm.JefeadministracionDAO.loadJefeadministracionByQuery(estadoJefeAdm, null);
